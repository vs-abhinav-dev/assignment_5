...
import { Plus, Check, Trash2, ListChecks, Loader2, Sparkles } from 'lucide-react';
        ...
        <div className="space-y-6">
          {loading ? (
            ...
            <div className="border-[3px] border-black p-12 text-center bg-white shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] border-dashed">
              <p className="text-2xl font-black uppercase italic">EMPTY_DATABASE</p>
            </div>
          ) : (
            tasks.map((task) => (
              <div
              ...
              >
                <div className="flex items-center gap-6">
                  ...
                  >
                    {task.completed && <Check className="text-white w-6 h-6 stroke-[4px]" />}
                  </button>
                  <span
